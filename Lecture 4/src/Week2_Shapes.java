...
interface IShape {
  ...
  //compute the distance to the origin of this IShape
  double distToOrigin();
}
...
class Circle implements IShape {
    ...
    //compute the distance to the origin of this Circle
...
class Square implements IShape {
    ...
    //compute the distance to the origin of this Square
    public double distToOrigin() {
      // TODO Auto-generated method stub
      return 0;
    }
...
class ExamplesShapes {
   ...
   // IShape combo2 = new Combo(s3, c2);
    
   // IShape combo3 = new Combo(this.combo1, this.combo2);
